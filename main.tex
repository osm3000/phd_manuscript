...
% \usepackage{natbib}
% \usepackage[semicolon,sort,numbers,square]{natbib}
...
% \usepackage{prettyref} % better reference format -- complete shit really

 \usepackage[stable]{footmisc} % to add footnotes to a section
...
\newenvironment{dedication} % In order to write a dedication
...
Thesis supervisor: G\'erard Bailly\\
Thesis co-supervisor: Damien Pellier}
\date{}
\begin{document}
...
\begin{dedication}
To my late father and my uncle, the two inspirations and aspirations of my life.
\end{dedication}
...
\part{Perspectives and Closing Remarks}
...
\appendix
\input{chapters/hyperparameters.tex}
\input{chapters/list_of_publications.tex}
\input{chapters/adversarial.tex}
% \setcounter{endnote}{0}
% \theendnotes

\bibliographystyle{plainnat} % I need to solve this style problem with the bibliography
% \bibliographystyle{ksfh_nat} % I need to solve this style problem with the bibliography
