...
\section{Putting it all together}
  ...
  \subsection{IRONOFF}
    ...
    \begin{itemize}
      ...
      \item From lowercase and digits to uppercase
    \end{itemize}
    ...
    \paragraph{BLEU score}
      ...
      \begin{table*}[!htbp]
        ...
        \begin{tabular}{|l||c|c|c||c|c|c|}
          ...
          Uppercase-baseline &   0 & 0 & 0 & 0 & 0 & 0 \\\hline
          Uppercase-transfer &   0 & 0 & 0 & 0 & 0 & 0 \\\hline
    ...
    \paragraph{EOS}
      ...
      \begin{table}[!htbp]
        ...
        Uppercase-baseline & \\ \hline
        Uppercase-transfer & \\ \hline
        Lowercase-baseline & \\ \hline
        Lowercase-transfer & \\ \hline
        Digits-baseline & \\ \hline
        Digits-transfer & \\ \hline
        \end{tabular}
        \caption{IRONOFF: Pearson correlation coefficients for the End-Of-Sequence (EoS) distributions between }
        \label{table:eos_ironoff_transfer}
      \end{table}
